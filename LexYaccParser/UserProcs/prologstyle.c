...
// Prefix:
  ...
  if ((strcmp(ss->sym, "thf_apply_formula")==0) || (strcmp(ss->sym, "thf_quantified_formula")==0) || (strcmp(ss->sym, "thf_abstraction")==0))
      printf("(");
// No children: 
...
//    if (strcmp(symbol, "COLON")==0) printf("(%s)",(ss->parent)->sym);
    ...
    {printf("\n");for (d = 0; d < depth; d++) printf(" ");}
    if ((strcmp(symbol, "GREATER")==0)||(strcmp(symbol, "QUESTION")==0)||(strcmp(symbol, "EXCLAMATION")==0)||
        (strcmp(symbol, "dollar_word")==0)||(strcmp(symbol, "AMPERSAND")==0)||(strcmp(symbol, "AT_SIGN")==0)) printf(" ");
    printf("%s", buf);
    if ((strcmp(symbol, "GREATER")==0)||(strcmp(symbol, "QUESTION")==0)||(strcmp(symbol, "EXCLAMATION")==0)||(strcmp(symbol, "dollar_word")==0)||
        (strcmp(symbol, "AT_SIGN")==0)||(strcmp(symbol, "AMPERSAND")==0)||(strcmp(symbol, "CARET")==0)) printf(" ");
