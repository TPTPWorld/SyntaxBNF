...
file_info : COMMA name {$<pval>$ = P_BUILD("file_info", P_TOKEN("COMMA ", $<ival>1), $<pval>2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | null {$<pval>$ = P_BUILD("file_info", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
parent_details : COLON general_list {$<pval>$ = P_BUILD("parent_details", P_TOKEN("COLON ", $<ival>1), $<pval>2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | null {$<pval>$ = P_BUILD("parent_details", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
