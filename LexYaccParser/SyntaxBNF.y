...
annotations : COMMA source optional_info {$<pval>$ = P_BUILD("annotations", P_TOKEN("COMMA ", $<ival>1), $<pval>2, $<pval>3,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | nothing {$<pval>$ = P_BUILD("annotations", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
tff_quantified_formula : tff_quantifier LBRKT tff_variable_list RBRKT COLON tff_unit_formula {$<pval>$ = P_BUILD("tff_quantified_formula", $<pval>1, P_TOKEN("LBRKT ", $<ival>2), $<pval>3, P_TOKEN("RBRKT ", $<ival>4), P_TOKEN("COLON ", $<ival>5), $<pval>6,NULL,NULL,NULL,NULL);}
                    ;
...
fof_formula_tuple : LBRKT RBRKT {$<pval>$ = P_BUILD("fof_formula_tuple", P_TOKEN("LBRKT ", $<ival>1), P_TOKEN("RBRKT ", $<ival>2),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | LBRKT fof_formula_tuple_list RBRKT {$<pval>$ = P_BUILD("fof_formula_tuple", P_TOKEN("LBRKT ", $<ival>1), $<pval>2, P_TOKEN("RBRKT ", $<ival>3),NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
sources : source {$<pval>$ = P_BUILD("sources", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | source COMMA sources {$<pval>$ = P_BUILD("sources", $<pval>1, P_TOKEN("COMMA ", $<ival>2), $<pval>3,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;

dag_source : name {$<pval>$ = P_BUILD("dag_source", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | inference_record {$<pval>$ = P_BUILD("dag_source", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;

inference_record : _LIT_inference LPAREN inference_rule COMMA useful_info COMMA parents RPAREN {$<pval>$ = P_BUILD("inference_record", P_TOKEN("_LIT_inference ", $<ival>1), P_TOKEN("LPAREN ", $<ival>2), $<pval>3, P_TOKEN("COMMA ", $<ival>4), $<pval>5, P_TOKEN("COMMA ", $<ival>6), $<pval>7, P_TOKEN("RPAREN ", $<ival>8),NULL,NULL);}
                    ;

inference_rule : atomic_word {$<pval>$ = P_BUILD("inference_rule", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;

internal_source : _LIT_introduced LPAREN intro_type COMMA useful_info COMMA parents RPAREN {$<pval>$ = P_BUILD("internal_source", P_TOKEN("_LIT_introduced ", $<ival>1), P_TOKEN("LPAREN ", $<ival>2), $<pval>3, P_TOKEN("COMMA ", $<ival>4), $<pval>5, P_TOKEN("COMMA ", $<ival>6), $<pval>7, P_TOKEN("RPAREN ", $<ival>8),NULL,NULL);}
                    ;

intro_type : atomic_word {$<pval>$ = P_BUILD("intro_type", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
parents : LBRKT RBRKT {$<pval>$ = P_BUILD("parents", P_TOKEN("LBRKT ", $<ival>1), P_TOKEN("RBRKT ", $<ival>2),NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | LBRKT parent_list RBRKT {$<pval>$ = P_BUILD("parents", P_TOKEN("LBRKT ", $<ival>1), $<pval>2, P_TOKEN("RBRKT ", $<ival>3),NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;

parent_list         : parent_info {$<pval>$ = P_BUILD("parent_list", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | parent_info COMMA parent_list {$<pval>$ = P_BUILD("parent_list", $<pval>1, P_TOKEN("COMMA ", $<ival>2), $<pval>3,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
optional_info : COMMA useful_info {$<pval>$ = P_BUILD("optional_info", P_TOKEN("COMMA ", $<ival>1), $<pval>2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    | nothing {$<pval>$ = P_BUILD("optional_info", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
...
include_optionals : nothing {$<pval>$ = P_BUILD("include_optionals", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
...
file_name : atomic_word {$<pval>$ = P_BUILD("file_name", $<pval>1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;

nothing : {$<pval>$ = P_BUILD("nothing",NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);}
                    ;
